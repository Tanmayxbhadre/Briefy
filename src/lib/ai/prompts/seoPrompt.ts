export function buildSeoPrompt(title: string, excerpt?: string, content?: string): string {
  return `You are an SEO Strategist at Briefy.live (briefy.live).
...
- seoTitle: 50 to 60 characters ideally (do not exceed 65 characters). Do not add a brand suffix; the website appends " | Briefy.live".
- metaDescription: 140 to 160 characters describing the story accurately.
- No keyword stuffing.

Return strictly a JSON object:
{
  "seoTitle": "Optimized Headline",
