...
async function runAllTests() {
  console.log('==================================================');
  console.log('Briefy.live PHASE 6 — COMPREHENSIVE TEST SUITE');
  console.log('==================================================\n');
  ...
  const validDraft = {
    ...
    seoTitle: 'NVIDIA Announces Blackwell Ultra GPUs',
  ...
  // core hourly-automation behavior — Briefy.live must not wait for a second outlet
